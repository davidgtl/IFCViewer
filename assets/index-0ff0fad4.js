...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ur,depthTest:!1,depthWrite:!1})}function Og(){return new Kr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Vh(),fragmentShader:`
		...
		`,blending:ur,depthTest:!1,depthWrite:!1})}function Ng(){return new Kr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Vh(),fragmentShader:`
